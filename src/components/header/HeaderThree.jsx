  ...
  return (
    <>
		<header className="page-header">
			<nav className="navbar bg-grey-light-three navbar__style-three" style={{backgroundColor: "#fde3e9;"}}>
				<div className="container">
					<div className="navbar-inner justify-content-between">
						...
						<div className="main-nav-wrapper text-end text-right">
							<ul className="main-navigation list-inline text-end text-right" ref={menuRef}>
								{
