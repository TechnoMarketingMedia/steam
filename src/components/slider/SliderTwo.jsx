...
import image2 from "/public/images/carshop.jpg"
...
const catchline = [
  "Rev up your ride with Jamaica's best car part provider",
  'Your go-to source for elusive car parts!',
  'Over a Decade of Service'
]
const lines = [
  {
    catchline:  "Rev up your ride with Jamaica's best car part provider",
    slug : "performance-parts"
  },
  {
    catchline:  "Your go-to source for elusive car parts!",
    slug: "service-parts"
  },
  {
    catchline:  "Over a Decade of Service",
    slug: "new-and-used"
  }
]
                ...
                {lines.map((data) =>(
                    <div className="item" key={data.slug}>
                        ...
                        <div className="btn-group">
                            <Link href={`/${data.slug}`}>
                                <a className="btn btn-primary m-r-xs-30">VIEW MORE PARTS</a>
                            </Link>
                        </div>
                    </div>
                ))}
